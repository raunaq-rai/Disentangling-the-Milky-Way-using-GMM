...
Having completed the reproducal of \citet{zhang2024existencemetalpoordiscmilky}, we extended XD-GMM analysis
to the high and low-$\alpha$ sequences of \citet{Vis2024}. Instead of fitting two GMMs as in \cite{Vis2024}, 
we determine the number of components in each metallicity bin, for each alpha sequence, by fitting GMMs with a 
range of components and selecting the one with the lowest BIC score. 
