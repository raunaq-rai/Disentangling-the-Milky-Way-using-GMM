...
phase-space coordinates for stars in each alpha-metallicity bin.
...
Figure~\ref{fig:v_over_sigma_alpha} shows the ratio of the mean rotational velocity to the azimuthal velocity dispersion, $V_{\rm rot}/\sigma_\phi$, for each GMM component. Symbol size represents the component weight, and colours match those in Figures~\ref{fig:gmm_4wide_hi} and \ref{fig:gmm_lowalpha_panel}. This metric quantifies rotational support—higher values suggest more disc-like kinematics.
...
\begin{figure}[H]
  ...
  \caption{Ratio of the mean rotational velocity to azimuthal velocity dispersion, $V_{\rm rot}/\sigma_\phi$, for individual GMM components in each metallicity bin. Larger circles represent more dominant components. Colours correspond to those in Figures~\ref{fig:gmm_4wide_hi} and \ref{fig:gmm_lowalpha_panel}.}
