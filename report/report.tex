...
The primary aim of this report is to follow reproduce the Extreme-Deconvolution 
Gaussian Mixture Model (XD-GMM) study of \citet{zhang2024existencemetalpoordiscmilky} who 
investigated the prescence of a very-metal poor disk in the Milky Way. The data set combines bright 
red-giant stars from \textit{Gaia} DR3 with homogeneous metallicities and XP‐based 
alpha abundances using data from \citet{Andrae2023}, \citet{Li2024} and \citet{BailerJones2021}. 

In general our results are in agreement with that of \citet{zhang2024existencemetalpoordiscmilky}: 
below \(\mathrm{[M/H]}\simeq-1.6\) there is no evidence for a coherent,   
...
any thick-disc contribution in the very-metal-poor interval \(-3.0<\mathrm{[M/H]}<-1.6\) must therefore be negligible.


Splitting the sample by alpha abundance adds further detail to the kinematic picture. 
This part of the analysis builds on the framework of \citet{Vis2024}, extending it by 
fitting an XD-GMM to each metallicity bin, with the optimal number of components 
selected via the Bayesian information criterion. Our findings are consistent with 
...
stars at the same metallicity remain more strongly halo-dominated. A notable and 
somewhat unexpected feature is the appearance of Gaia--Sausage/Enceladus (GS/E)-like 
