...
%TC:ignore
\noindent\textbf{VMP} (\texttt{-3\textless[M/H]\textless-2}):\\
\href{https://raw.githack.com/raunaq-rai/Disentangling-the-Milky-Way-using-GMM/main/figures/VMP__-3%5BM_H%5D-2.html}{VMP link}\\[6pt]

\noindent\textbf{IMP} (\texttt{-2\textless[M/H]\textless-1.6}):\\
\href{https://raw.githack.com/raunaq-rai/Disentangling-the-Milky-Way-using-GMM/main/figures/IMP__-2%5BM_H%5D-1.6.html}{IMP link}\\[6pt]

\noindent\textbf{MP1} (\texttt{-1.6\textless[M/H]\textless-1.3}):\\
\href{https://raw.githack.com/raunaq-rai/Disentangling-the-Milky-Way-using-GMM/main/figures/MP1__-1.6%5BM_H%5D-1.3.html}{MP1 link}\\[6pt]

\noindent\textbf{MP2} (\texttt{-1.3\textless[M/H]\textless-1.0}):\\
...
%TC:ignore
\noindent\textbf{High–$\alpha$ VMP (\texttt{-3<[M/H]<-2})}:  
...
\noindent\textbf{High–$\alpha$ IMP (\texttt{-2<[M/H]<-1.6})}:  
...
\noindent\textbf{High–$\alpha$ MP1 (\texttt{-1.6<[M/H]<-1.3})}:  
...
\noindent\textbf{High–$\alpha$ MP2 (\texttt{-1.3<[M/H]<-1.0})}:  
