...
Cosmological simulations generally favour scenario\;2: early mergers dominate the VMP star budget, 
...
See the fully interactive 3-D GMM decompositions served via RawGitHack:

\begin{itemize}
  \item \textbf{High–$\alpha$ VMP (\texttt{-3<[M/H]<-2})}:%
    \href{\detokenize{https://raw.githack.com/raunaq-rai/Disentangling-the-Milky-Way-using-GMM/main/figures/VMP_high___-3[M_H]-2.html}}{High–$\alpha$ VMP}

  \item \textbf{High–$\alpha$ IMP (\texttt{-2<[M/H]<-1.6})}:%
    \href{\detokenize{https://raw.githack.com/raunaq-rai/Disentangling-the-Milky-Way-using-GMM/main/figures/IMP_high___-2[M_H]-1.6.html}}{High–$\alpha$ IMP}

  \item \textbf{High–$\alpha$ MP1 (\texttt{-1.6<[M/H]<-1.3})}:%
    \href{\detokenize{https://raw.githack.com/raunaq-rai/Disentangling-the-Milky-Way-using-GMM/main/figures/MP1_high___-1.6[M_H]-1.3.html}}{High–$\alpha$ MP1}

  \item \textbf{High–$\alpha$ MP2 (\texttt{-1.3<[M/H]<-1.0})}:%
    \href{\detokenize{https://raw.githack.com/raunaq-rai/Disentangling-the-Milky-Way-using-GMM/main/figures/MP2_high___-1.3[M_H]-1.0.html}}{High–$\alpha$ MP2}
\end{itemize}
...
\begin{itemize}
  \item \textbf{Low–$\alpha$ VMP (\texttt{-3<[M/H]<-2})}:%
    \href{\detokenize{https://raw.githack.com/raunaq-rai/Disentangling-the-Milky-Way-using-GMM/main/figures/VMP_low____-3[M_H]-2.html}}{Low–$\alpha$ VMP}

  \item \textbf{Low–$\alpha$ IMP (\texttt{-2<[M/H]<-1.6})}:%
    \href{\detokenize{https://raw.githack.com/raunaq-rai/Disentangling-the-Milky-Way-using-GMM/main/figures/IMP_low____-2[M_H]-1.6.html}}{Low–$\alpha$ IMP}

  \item \textbf{Low–$\alpha$ MP1 (\texttt{-1.6<[M/H]<-1.3})}:%
    \href{\detokenize{https://raw.githack.com/raunaq-rai/Disentangling-the-Milky-Way-using-GMM/main/figures/MP1_low____-1.6[M_H]-1.3.html}}{Low–$\alpha$ MP1}

  \item \textbf{Low–$\alpha$ MP2 (\texttt{-1.3<[M/H]<-1.0})}:%
    \href{\detokenize{https://raw.githack.com/raunaq-rai/Disentangling-the-Milky-Way-using-GMM/main/figures/MP2_low____-1.3[M_H]-1.0.html}}{Low–$\alpha$ MP2}
\end{itemize}
