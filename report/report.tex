...
\paragraph{EDIT THE BELOW...}


\paragraph{Disc onset (MP1; $-1.6<[\mathrm{M/H}]<-1.3$).}
A genuine thick-disc Gaussian appears in both sequences, but with markedly different prominence and kinematics.  
In the high-$\alpha$ mixture, the thick disc accounts for 31\% of the stars, rotating at 
$v_{\phi}\!\sim\!148$\,km\,s$^{-1}$ with relatively low dispersion, indicating the emergence of a warm, 
\textit{in-situ} rotating structure.  
The low-$\alpha$ sample is still dominated by non-disc components: the stationary halo and GSE account for 72.8\% 
...
metallicity remain primarily associated with accreted debris.
...
\medskip
Overall, the high-$\alpha$ sequence evolves from halo to kinematically warm
thick disc between $[\mathrm{M/H}]\!\simeq\!-1.6$ and $-1.3$.
The low-$\alpha$ sequence gains rotation earlier but stays halo-dominated
until $[\mathrm{M/H}]\!\gtrsim\!-1.3$.
Persistent GSE-type Gaussians in every low-$\alpha$ bin underscore the
lasting dynamical imprint of the last major merger, whereas the cleaner
three-component mix in the high-$\alpha$/MP2 slice signals an earlier,
\textit{in-situ} thick-disc consolidation.  
Together, the two branches echo the “two-phase’’ disc-building picture of
\citet{Haywood2013}: an early $\alpha$-rich epoch forming the thick disc,
followed by a later $\alpha$-poor phase assembling the thin disc from
increasingly enriched and dynamically cooler gas.
