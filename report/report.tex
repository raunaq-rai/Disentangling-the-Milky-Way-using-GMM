...
%TC:ignore
\setlength\parskip{2pt}  % reduce inter‐paragraph skip locally
...
In the very-metal-poor (VMP; $[\mathrm{M/H}] < -2$) regime, both high- and low-$\alpha$ 
populations are best fit by a single, non-rotating, isotropic halo component. The similarity 
between the two sequences suggests that the structure of the stellar halo at these metallicities 
is insensitive to $\alpha$-abundance.

In the intermediate-metallicity regime (IMP; $-2.0 < [\mathrm{M/H}] < -1.6$), the low-$\alpha$ 
sample separates cleanly into stationary and prograde halo components. In contrast, the 
high-$\alpha$ fit yields four components, including two with highly radial kinematics. These are 
less physically interpretable and likely reflect overfitting or contamination from $\alpha$-poor 
stars misclassified at low signal-to-noise, rather than indicating the presence of a genuine 
high-$\alpha$ GSE population.

At moderately poor metallicity (MP1; $-1.6 < [\mathrm{M/H}] < -1.3$), a thick-disc component 
emerges clearly in the high-$\alpha$ population, as expected from in-situ star formation and early 
disc settling. In the low-$\alpha$ sequence, however, a distinct GSE-like component is now evident. 
This supports the idea that the GSE merger contributed significantly at this metallicity, consistent 
with the hypothesis that its stars were deposited after the high-$\alpha$ disc had begun to form 
\citep{Helmi2018}.

In the metal-richest bin (MP2; $-1.3 < [\mathrm{M/H}] < -1.0$), both sequences show prominent 
thick-disc components, though the high-$\alpha$ disc is more dominant (52\%) and kinematically 
warmer. The low-$\alpha$ thick disc is cooler and less massive (25\%), consistent with a younger, 
possibly thin-disc progenitor. The absence of an ultra-cold thin disc in either case reflects the 
selection bias against stars near the Galactic plane.
